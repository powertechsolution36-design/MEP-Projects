...
const MENUS = {
  ...
  hvac_dm: [ // HVAC Division Manager — full company access except Users
    { to: '/',                     label: 'Dashboard',        icon: '🏠', end: true },
    { to: '/customers',            label: 'Customers',        icon: '🏛️' },
    { to: '/enquiries',            label: 'Enquiries',        icon: '📋' },
  ...
  solar_dm: [ // Solar Division Manager
    { to: '/',                     label: 'Dashboard',        icon: '🏠', end: true },
    { to: '/customers',            label: 'Customers',        icon: '🏛️' },
    { to: '/enquiries',            label: 'Enquiries',        icon: '📋' },
    { to: '/quotations',           label: 'Quotations',       icon: '📄' },
