export const ROLE_META = {
  ...
  hvac_dm: {
    label: 'HVAC Manager',
    subtitle: 'HVAC Division Head',
    icon: '❄️',
    color: '#0891b2',
    responsibilities: [
      'Full oversight of HVAC division',
      'Manage HVAC enquiries, quotations, sales orders',
      'Approve projects and track profitability',
      'Oversee HVAC inventory and service',
    ],
  },
  solar_dm: {
    label: 'Solar Manager',
    subtitle: 'Solar Division Head',
    icon: '☀️',
    color: '#d98a00',
    responsibilities: [
      'Full oversight of Solar division',
      'Manage Solar enquiries, quotations, sales orders',
      'Approve projects and track profitability',
      'Oversee Solar inventory and service',
    ],
  },
  mep_dm: {
    label: 'MEP Manager',
    subtitle: 'MEP Division Head',
    icon: '🏗️',
    color: '#7c3aed',
    responsibilities: [
      'Full oversight of MEP division',
      'Manage MEP enquiries, quotations, sales orders',
      'Approve projects and track profitability',
      'Oversee MEP inventory and service',
    ],
  },
  service_mgr: {
...
export const ROLE_MODULES = {
  ...
  hvac_dm:     ['/', '/customers', '/enquiries', '/quotations', '/sales-orders', '/lost-enquiries', '/projects', '/service-calls', '/contracts', '/payments', '/inventory', '/checklists', '/reports', '/notifications'],
  solar_dm:    ['/', '/customers', '/enquiries', '/quotations', '/sales-orders', '/lost-enquiries', '/projects', '/service-calls', '/contracts', '/payments', '/inventory', '/checklists', '/reports', '/notifications'],
  mep_dm:      ['/', '/customers', '/enquiries', '/quotations', '/sales-orders', '/lost-enquiries', '/projects', '/service-calls', '/contracts', '/payments', '/inventory', '/checklists', '/reports', '/notifications'],
...
export function roleOptions(includeSuper = false) {
  const order = ['admin', 'hvac_dm', 'solar_dm', 'mep_dm', 'mep_pm', 'hvac_pm', 'solar_pm', 'sales', 'service_mgr', 'service_eng', 'engineer', 'store', 'accounts', 'viewer'];
